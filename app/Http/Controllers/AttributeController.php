...
class AttributeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Bảng attribute trong SQL của bạn chỉ có id và name, không có created_at
        // nên ta save() bình thường, Eloquent tự xử lý timestamps nếu model bật, 
        // nhưng file SQL không có cột đó => Phải tắt timestamps trong Model
        $attr->save();
